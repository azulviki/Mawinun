...
//MODO COMPLEJO
const PROBABILIDAD_REENCENDIDO = 0.0008; // Una vez cada pocos segundos, por árbol apagado
const MAX_REENCENDIDOS = 4; // Máximo de veces que un árbol puede reencenderse
